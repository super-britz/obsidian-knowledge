...
- `_meta/00-维护入口.md`：维护规则、流程、模板和状态表的总入口。
- `_meta/00-维护日志.md`：按日期和任务主题合并的维护日志。
...
2. 让 Codex 摄取这份资料。
3. 检查 `wiki/` 中生成或更新的页面。
4. 需要查看整理流程或状态时，读取 `_meta/00-维护入口.md`。
5. 在 Obsidian 中浏览链接、图谱视图和历史记录。
